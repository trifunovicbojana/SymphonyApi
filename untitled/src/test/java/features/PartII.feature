Feature: Part II
  ...
  Scenario: Register new user
    Given user register new account with valid data email "testbojana@example.com", password "password1234", firstName "John", lastName "Doe", username "testBojana" and dateOfBirth "01/01/1990"
  ...
  Scenario: Sign in with newly created user
    Given registered user is logged in with username "testBojana" and password "password1234"
    When user logins
